...
import { protectedModals } from '../../components/ProtectedButton/ProtectedButton'
...
@inject('authorizedProtocolStore', 'publicAddressStore', 'executeContractStore', 'networkStore', 'portfolioStore')
@observer
class AuthorizedProtocol extends Component<Props, State> {
  ...
  renderErrorResponse() {
    const { status, errorMessage } = this.props.executeContractStore
    if (status !== 'error') {
      return null
    }
    return (
          ...
          <Flexbox className="page-title" flexDirection="column">
            ...
            <h3 className="page-title">
              ...
              <a target='_blank' rel='noreferrer noopener'
                href={`https://${this.getLink}zp.io/governance`} >
        ...
        <Flexbox flexDirection="column">
          ...
          {showLink && (
              <p>
                Please go to the
                <a target='_blank' rel='noreferrer noopener'
                   href={`https://${link}zp.io/governance`} >
                <span className="underline" >
                  Block Explorer
                </span>
                </a>
